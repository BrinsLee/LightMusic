...
class MinePresenter @Inject constructor() : MineContract.Presenter {

    private var mView: MineContract.View? = null
    ...
    override fun subscribe(view: MineContract.View) {
        mView = view
    }
